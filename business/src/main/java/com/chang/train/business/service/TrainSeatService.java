...
import com.chang.train.business.domain.TrainCarriage;
import com.chang.train.business.domain.TrainSeat;
import com.chang.train.business.domain.TrainSeatExample;
import com.chang.train.business.enums.SeatColEnum;
import com.chang.train.business.mapper.TrainSeatMapper;
...
public class TrainSeatService {
    ...
    public void genTrainSeat(String trainCode) {
        ...
        for (TrainCarriage trainCarriage : carriageList) {
            ...
            // 循环查表： 考虑事务，且一般不会经常执行，在初始化的时候执行一次。所以还是可以考虑的。
            // 循环行数
